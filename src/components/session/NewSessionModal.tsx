...
function PlaceholderSelect({ placeholder }: { placeholder: string }) {
  return (
    <div className="flex h-9 w-full items-center justify-between rounded-md border border-ink-200 bg-white px-3 text-sm text-ink-400 hover:bg-ink-50">
      {placeholder}
    ...
    <Modal
      ...
      footer={
        <>
          ...
          <Button variant="primary" onClick={onClose}>Create session</Button>
        </>
      }
    >
